...
export default function PredominantColorsList() {
  ...
  const formatAbsorptance = (min: any, max: any) => {
    if (min == null && max == null) return "—";
    const minStr = min != null ? Number(min).toFixed(3) : "0.000";
    const maxStr = max != null ? Number(max).toFixed(3) : "1.000";
  ...
  return (
    <div className="flex h-screen bg-slate-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <Header
          title="Cores Predominantes"
          description="Gerencie as cores predominantes de fachada"
          action={
              ...
              <Table className="table-fixed">
                <TableHeader>
                  <TableRow className="bg-slate-100/60">
                    ...
                    <TableHead className="w-[18%]">Absortância</TableHead>
                ...
                <TableBody>
                  {pagedItems.map((t: PredominantColor) => (
                    <TableRow key={t.id}>
                      ...
                      <TableCell>
                        {formatAbsorptance((t as any).absorptanceMin, (t as any).absorptanceMax)}
                      </TableCell>
