...
type TechnicianForm = z.infer<typeof schema>;
...
export default function NewTechnician() {
  ...
  const form = useForm<TechnicianForm>({ resolver: zodResolver(schema), defaultValues: {} as any });
  ...
  return (
    <div className="flex h-screen bg-slate-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <Header title="Novo Responsável Técnico" description="Preencha os dados do profissional" />
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <FormField name="creaCau" control={form.control} render={({ field }) => (
                    <FormItem>
                      <FormLabel>CREA/CAU *</FormLabel>
                      <FormControl><Input {...field} placeholder="Número do registro" /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                  <FormField name="registrationType" control={form.control} render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Input {...field} placeholder="CREA ou CAU" /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                  <FormField name="licenseState" control={form.control} render={({ field }) => (
                    <FormItem>
                      <FormLabel>UF do Registro</FormLabel>
                      <FormControl><Input {...field} placeholder="UF" maxLength={2} /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                  ...
                  <FormField name="email" control={form.control} render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Input type="email" {...field} placeholder="email@exemplo.com" /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                  ...
                  <FormField name="notes" control={form.control} render={({ field }) => (
                    <FormItem className="md:col-span-2">
                      ...
                      <FormControl><Input {...field} placeholder="Notas adicionais" /></FormControl>
                      <FormMessage />
                    </FormItem>
                  )} />
                </div>
